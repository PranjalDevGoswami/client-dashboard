...
# Load data
file_path = r'C:\Users\Contract.DESKTOP-AF4IHN4\EduDashboard\Raw_Data_File-21122022_V1.xlsx'
...
# print("Age Group Value:", age_group_value)
# print("Education Value:", education_value)
...
#         x='A7',
#         title='Distribution of Education Levels',
#         labels={'A7': 'Education Level'},
#         nbins=len(education_mapping)
#     )
...
# else:
#     st.write("No data to display in histogram.")
